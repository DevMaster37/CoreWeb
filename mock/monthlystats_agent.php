                  ...
                  $a = $db->accounts->find(array('type' => 'agent'));
                   ...
                   for ($i=30; $i > 0; $i--) {
                       ...
                       $dresu= array();
                           ...
                           $fail = $db->topuplogs->find(array('account' => $x['_id'], 'time' => array('$gte' => new MongoDate($start), '$lte' => new MongoDate($end)), 'success' => true ))->count();
